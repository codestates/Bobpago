...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, type: create_user_res_dto_1.CreateUserResDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'tokenType', required: true }),
    (0, swagger_1.ApiResponse)({ status: 200, type: update_user_res_dto_1.UpdateUserResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiNotFoundResponse)({ type: http_exception_dto_1.NotFoundErrorRes }),
    (0, common_1.Patch)('me'),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'tokenType', required: true }),
    (0, swagger_1.ApiResponse)({ status: 200, type: delete_user_res_dto_1.DeleteUserResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiInternalServerErrorResponse)({ type: http_exception_dto_1.InternalServerErrorRes }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: restore_user_res_dto_1.RestoreUserResDto }),
    (0, swagger_1.ApiNotFoundResponse)({ description: '데이터 불일치', type: http_exception_dto_1.NotFoundErrorRes }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'tokenType', required: true }),
    (0, swagger_1.ApiResponse)({ status: 200, type: checkInfo_user_res_dto_1.CheckInfoUserResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiNotFoundResponse)({ type: http_exception_dto_1.NotFoundErrorRes }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, type: create_bookmark_res_dto_1.CreateBookmarkResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiConflictResponse)({ type: http_exception_dto_1.ConflictErrorRes }),
    (0, swagger_1.ApiInternalServerErrorResponse)({ type: http_exception_dto_1.InternalServerErrorRes }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'tokenType', required: true }),
    (0, swagger_1.ApiParam)({ name: 'recipeId', required: true }),
    (0, swagger_1.ApiResponse)({ status: 200, type: delete_bookmark_res_dto_1.DeleteBookmarkResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
