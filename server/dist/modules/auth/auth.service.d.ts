...
export declare class AuthService {
    ...
    signOut(tokenType: string, accessToken: string, res: Response): Promise<CheckSignOutResDto>;
    newGenerateToken(userId: number, tokenType: string, req: Request): Promise<GenereateTokenResDto>;
