...
const check_signout_req_dto_1 = require("./dto/request-dto/check-signout.req.dto");
const generate_token_req_dto_1 = require("./dto/request-dto/generate-token.req.dto");
const check_userId_req_dto_1 = require("./dto/request-dto/check-userId.req.dto");
...
let AuthController = class AuthController {
    ...
    signOut(query, headers, res) {
        return this.authService.signOut(query.tokenType, headers.accessToken, res);
    }
    generateToken(param, query, req) {
        return this.authService.newGenerateToken(param.userId, query.tokenType, req);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: check_signout_res_dto_1.CheckSignOutResDto }),
    (0, swagger_1.ApiUnauthorizedResponse)({ type: http_exception_dto_1.UnauthorizedErrorRes }),
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiNotFoundResponse)({ type: http_exception_dto_1.NotFoundErrorRes }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [check_signout_req_dto_1.CheckSignOutReqDto, Object, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [check_userId_req_dto_1.CheckUserIdReqDto,
        generate_token_req_dto_1.GenereateTokenReqDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiBadRequestResponse)({ type: http_exception_dto_1.BadRequestErrorRes }),
    (0, swagger_1.ApiNotAcceptableResponse)({ type: http_exception_dto_1.NotAcceptableErrorRes }),
    (0, swagger_1.ApiInternalServerErrorResponse)({ type: http_exception_dto_1.InternalServerErrorRes }),
