...
export const ProfileContainer = styled.div<SizeProps>`
  ...
  @media screen and (max-width: 768px) {
    width: ${(props) => (props.size ? (props.size * 1) / 2 + "em" : "1em")};
    height: ${(props) => (props.size ? (props.size * 1) / 2 + "em" : "1em")};
  }
...
export const ProfileIcon = styled(Man)<SizeProps>`
  ...
  @media screen and (max-width: 768px) {
    width: ${(props) => (props.size ? (props.size * 3) / 4 + "em" : "1em")};
    height: ${(props) => (props.size ? (props.size * 3) / 4 + "em" : "1em")};
  }
  @media screen and (max-width: 480px) {
    width: ${(props) => (props.size ? (props.size * 3) / 5 + "em" : "1em")};
    height: ${(props) => (props.size ? (props.size * 3) / 5 + "em" : "1em")};
  }
`;
